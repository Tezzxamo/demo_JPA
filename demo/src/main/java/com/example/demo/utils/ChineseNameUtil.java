...
public class ChineseNameUtil {
    ...
    private static final String[] doubleSurName = {"司马","上官","欧阳","夏侯","诸葛","东方","赫连",
            "皇甫","尉迟","澹台","淳于","申屠", "公孙","轩辕","令狐","宇文","长孙","慕容","司徒", "百里","呼延","西门","南宫"};
    ...
    public static void main(String[] args) {
        for (int i=1 ; i<=100;i++){
            ...
            if (i % 2 == 0) {
                simple = true;
                System.out.println(getName(simple,3));
            } else {
                simple = false;
                System.out.println(getName(simple,4));
            }
        }
    }
}
